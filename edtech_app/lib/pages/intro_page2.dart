import 'package:edtech_app/pages/intro_page3.dart';
      ...
      [
        SizedBox(height: 100,),
         ...
         Container(
           width: 375,
           height: 264,
          child: Image.asset("lib/assets/images/illustration-2.png",
          fit: BoxFit.fill)
          ),
        ...
        Center(
          child: Text("Find a course", style: GoogleFonts.rubik(
            textStyle: TextStyle(
        ...
        Center(
          child: Text("for you", style: GoogleFonts.rubik(
            textStyle: TextStyle(
             color: Color(0xFF3C3A36),
             fontSize: 24,
             fontWeight: FontWeight.w500,
